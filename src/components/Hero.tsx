...
const Hero: React.FC = () => {
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center bg-[#1e2326] overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1100px] mx-auto px-5 text-center">
        ...
        >
          Especializado en <span className="text-white font-semibold italic">Transformación Digital</span> mediante el diseño de arquitectura de software y desarrollo <span className="text-white border-b-2 border-[#1CB698]">Full-Stack</span> orientado a resultados.
        </motion.p>
